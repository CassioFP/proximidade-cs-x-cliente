...
Solução simples, onde ```getCsBalancing``` é responsável por organizar o total de clientes por CS e ```customerSuccessBalancing``` pega estes dados e verifica as regras em nível mais negocial, como empate, retornos vazios e ausência de CS para antendimento
